            ...
            <div class="col-lg-10 mb-4">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary text-uppercase">Tambah Penduduk Pindah</h6>

                    </div>

                    <div class="card-body">
                        <form action="/pindah/save" method="POST">
                            <div class="form-group">
                                <label for="id_pdd" class="mt-1">NIK</label>
                                <select name="id_pdd" class="form-control form select <?= ($validation->hasError('id_pdd')) ? 'is-invalid' : ''; ?>">
                                ...
                                <div class="invalid-feedback">
                                    <?= $validation->getError('id_pdd'); ?>
                                </div>
                                <label for="" class="mt-1">Tanggal Pindah</label>
                                <input type="date" class="form-control" name="tanggal_pindah" placeholder="silahkan pilih tanggal">
                                <label for="alasan" class="mt-1">Alasan Pindah</label>
                                <input class="form-control <?= ($validation->hasError('alasan')) ? 'is-invalid' : ''; ?>" name="alasan" placeholder="masukan alasan" value="<?= old('alasan') ?>">
                                </input>
                                <div class="invalid-feedback">
