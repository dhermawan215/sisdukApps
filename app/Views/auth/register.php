                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form action="<?= route_to('register') ?>" class="user" method="post">
                            ...
                            <small id="emailHelp" class="form-text text-muted mb-2"><?= lang('Auth.weNeverShare') ?></small>
                            <div class=" form-group">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="password" class="form-control form-control-user <?php if (session('errors.password')) : ?>is-invalid<?php endif ?>" name="password" placeholder="<?= lang('Auth.password') ?>" placeholder="Password" autocomplete="off">
                                </div>
                                <div class="col-sm-6">
