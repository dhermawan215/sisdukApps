...
<head>
    ...
    <link href="<?= base_url() ?>/frontend/css/styles.css" rel="stylesheet" />
</head>
...
<body id="page-top">
    ...
    <div class="copyright py-4 text-center text-white">
        <div class="container"><small>Copyright © <?= $footer ?> 2020</small></div>
    </div>
    ...
    <!-- Contact form JS-->
    <script src="<?= base_url() ?>/frontend/assets/mail/jqBootstrapValidation.js"></script>
    <script src="<?= base_url() ?>/frontend/assets/mail/contact_me.js"></script>
    <!-- Core theme JS-->
